...
select avg(monthly_salary) as avg_salary from employees e 
join roles_employee re ON e.id = re.employee_id 
join roles r on re.role_id = r.id
join employee_salary es on re.employee_id = es.employee_id 
join salary s on s.id = es.salary_id
...
select sum(monthly_salary) as sum_salary from employees e 
join roles_employee re ON e.id = re.employee_id 
join roles r on re.role_id = r.id
join employee_salary es on re.employee_id = es.employee_id 
join salary s on s.id = es.salary_id
...
select min(monthly_salary) as min_salary from employees e 
join roles_employee re ON e.id = re.employee_id 
join roles r on re.role_id = r.id
join employee_salary es on re.employee_id = es.employee_id 
join salary s on s.id = es.salary_id
...
select max(monthly_salary) as max_salary from employees e 
join roles_employee re ON e.id = re.employee_id 
join roles r on re.role_id = r.id
join employee_salary es on re.employee_id = es.employee_id  
join salary s on s.id = es.salary_id
...
select count(employee_name) as count_QA from employees e 
join roles_employee re ON e.id = re.employee_id 
join roles r on re.role_id = r.id
join employee_salary es on re.employee_id = es.employee_id 
join salary s on s.id = es.salary_id
...
select count(employee_name) as count_middle from employees e 
join roles_employee re ON e.id = re.employee_id 
join roles r on re.role_id = r.id
join employee_salary es on re.employee_id = es.employee_id 
join salary s on s.id = es.salary_id
...
select count(employee_name) as count_dev from employees e 
join roles_employee re ON e.id = re.employee_id 
join roles r on re.role_id = r.id
join employee_salary es on re.employee_id = es.employee_id 
join salary s on s.id = es.salary_id
