...
print('result_m_s_root =', result_s_root)
...
print('resut_mp_s_root =', result_mp_s_root)
...
#  58. Создать переменную b_item_t_int и присвоить явное приведение b_item_t к int
b_item_t_int = int(b_item_t)
#  59. Вывести b_item_1_int в консоль.
print('b_item_t_int =', b_item_t_int)
#  60. Создать переменную b_item_f_int и присвоить явное приведение b_item_f к int
